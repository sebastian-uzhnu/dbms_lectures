import { getCurrentInstance, ref, watch, computed, inject, hasInjectionContext, unref, defineAsyncComponent, toRef, isRef, toValue, onServerPrefetch, defineComponent, shallowRef, h, resolveComponent, shallowReactive, withAsyncContext, mergeProps, createVNode, resolveDynamicComponent, withCtx, openBlock, createBlock, createCommentVNode, toDisplayString, renderSlot, readonly, nextTick, getCurrentScope, onScopeDispose, createElementBlock, provide, cloneVNode, useSSRContext, Suspense, Fragment, createApp, reactive, createTextVNode, renderList, onErrorCaptured, effectScope, createSlots, isReadonly, isShallow, isReactive, toRaw } from 'file:///Users/sebastian/Documents/Code/college/database_lectures/node_modules/vue/index.mjs';
import { $fetch as $fetch$1 } from 'file:///Users/sebastian/Documents/Code/college/database_lectures/node_modules/ofetch/dist/node.mjs';
...
import { getContext, executeAsync } from 'file:///Users/sebastian/Documents/Code/college/database_lectures/node_modules/unctx/dist/index.mjs';
import { createError as createError$1, getRequestHeader, sanitizeStatusCode, setCookie, getCookie, deleteCookie, appendHeader } from 'file:///Users/sebastian/Documents/Code/college/database_lectures/node_modules/h3/dist/index.mjs';
import { RouterView, createMemoryHistory, createRouter, START_LOCATION } from 'file:///Users/sebastian/Documents/Code/college/database_lectures/node_modules/vue-router/vue-router.node.mjs';
import { toRouteMatcher, createRouter as createRouter$1 } from 'file:///Users/sebastian/Documents/Code/college/database_lectures/node_modules/radix3/dist/index.mjs';
import defu$1, { defuFn, defu } from 'file:///Users/sebastian/Documents/Code/college/database_lectures/node_modules/defu/dist/defu.mjs';
import { withLeadingSlash, joinURL, withoutTrailingSlash, withBase, parseQuery, withTrailingSlash, hasProtocol, withQuery, isScriptProtocol } from 'file:///Users/sebastian/Documents/Code/college/database_lectures/node_modules/ufo/dist/index.mjs';
import { hash } from 'file:///Users/sebastian/Documents/Code/college/database_lectures/node_modules/ohash/dist/index.mjs';
import { klona } from 'file:///Users/sebastian/Documents/Code/college/database_lectures/node_modules/klona/dist/index.mjs';
import { parse } from 'file:///Users/sebastian/Documents/Code/college/database_lectures/node_modules/nuxt/node_modules/cookie-es/dist/index.mjs';
import destr from 'file:///Users/sebastian/Documents/Code/college/database_lectures/node_modules/destr/dist/index.mjs';
import { isEqual } from 'file:///Users/sebastian/Documents/Code/college/database_lectures/node_modules/nuxt/node_modules/ohash/dist/index.mjs';
import { nanoid } from 'file:///Users/sebastian/Documents/Code/college/database_lectures/node_modules/nanoid/index.js';
import { kebabCase } from 'file:///Users/sebastian/Documents/Code/college/database_lectures/node_modules/scule/dist/index.mjs';
import { ssrRenderAttrs, ssrRenderComponent, ssrRenderVNode, ssrInterpolate, ssrRenderList, ssrRenderClass, ssrRenderSlot, ssrRenderTeleport, ssrRenderAttr, ssrRenderSuspense, ssrRenderStyle } from 'file:///Users/sebastian/Documents/Code/college/database_lectures/node_modules/vue/server-renderer/index.mjs';
import { Icon as Icon$1 } from 'file:///Users/sebastian/Documents/Code/college/database_lectures/node_modules/@iconify/vue/dist/offline.mjs';
import { loadIcon } from 'file:///Users/sebastian/Documents/Code/college/database_lectures/node_modules/@iconify/vue/dist/iconify.mjs';
import { useFuse } from 'file:///Users/sebastian/Documents/Code/college/database_lectures/node_modules/@vueuse/integrations/useFuse.mjs';
import { useFocusTrap } from 'file:///Users/sebastian/Documents/Code/college/database_lectures/node_modules/@vueuse/integrations/useFocusTrap.mjs';
import { debounce } from 'file:///Users/sebastian/Documents/Code/college/database_lectures/node_modules/nuxt/node_modules/perfect-debounce/dist/index.mjs';
...
const _routes = [
  {
    name: "slug",
    path: "/:slug(.*)*",
    component: () => import('./document-driven-Cm4nHMVl.mjs')
  }
];
...
const LazyDocumentDrivenNotFound = defineAsyncComponent(() => import('./DocumentDrivenNotFound-PqjcmK2u.mjs').then((r) => r["default"] || r.default || r));
const LazyEllipsis = defineAsyncComponent(() => import('./Ellipsis-DiqazgFR.mjs').then((r) => r["default"] || r.default || r));
...
const LazyDocsAside = defineAsyncComponent(() => import('./DocsAside-BnT8Ev2Z.mjs').then((r) => r["default"] || r.default || r));
const LazyDocsAsideTree = defineAsyncComponent(() => Promise.resolve().then(() => DocsAsideTree).then((r) => r["default"] || r.default || r));
const LazyDocsPageBottom = defineAsyncComponent(() => import('./DocsPageBottom-CeQv-V02.mjs').then((r) => r["default"] || r.default || r));
const LazyDocsPageLayout = defineAsyncComponent(() => import('./DocsPageLayout-DIPLh2X6.mjs').then((r) => r["default"] || r.default || r));
const LazyDocsPrevNext = defineAsyncComponent(() => import('./DocsPrevNext-BujzMhDr.mjs').then((r) => r["default"] || r.default || r));
const LazyDocsToc = defineAsyncComponent(() => import('./DocsToc-CUor8J67.mjs').then((r) => r["default"] || r.default || r));
const LazyDocsTocLinks = defineAsyncComponent(() => import('./DocsTocLinks-BFwZ1AfP.mjs').then((r) => r["default"] || r.default || r));
const LazyEditOnLink = defineAsyncComponent(() => import('./EditOnLink-DLin4KUm.mjs').then((r) => r["default"] || r.default || r));
const LazySourceLink = defineAsyncComponent(() => import('./SourceLink-CNUYYLqe.mjs').then((r) => r["default"] || r.default || r));
const LazyProseA = defineAsyncComponent(() => import('./ProseA-BnsvjnGv.mjs').then((r) => r["default"] || r.default || r));
const LazyProseBlockquote = defineAsyncComponent(() => import('./ProseBlockquote-C3RkHBzf.mjs').then((r) => r["default"] || r.default || r));
const LazyProseCode = defineAsyncComponent(() => import('./ProseCode-BJ0JakOr.mjs').then((r) => r["default"] || r.default || r));
const LazyProseCodeInline = defineAsyncComponent(() => import('./ProseCodeInline-BvnecwDi.mjs').then((r) => r["default"] || r.default || r));
const LazyProseEm = defineAsyncComponent(() => import('./ProseEm-Ddjn7LQU.mjs').then((r) => r["default"] || r.default || r));
const LazyProseH1 = defineAsyncComponent(() => import('./ProseH1-Dk1pl2sp.mjs').then((r) => r["default"] || r.default || r));
const LazyProseH2 = defineAsyncComponent(() => import('./ProseH2-DZfWrIU2.mjs').then((r) => r["default"] || r.default || r));
const LazyProseH3 = defineAsyncComponent(() => import('./ProseH3-Bxfh5A8M.mjs').then((r) => r["default"] || r.default || r));
const LazyProseH4 = defineAsyncComponent(() => import('./ProseH4-DfAnB5jB.mjs').then((r) => r["default"] || r.default || r));
const LazyProseH5 = defineAsyncComponent(() => import('./ProseH5-HSkkzPyu.mjs').then((r) => r["default"] || r.default || r));
const LazyProseH6 = defineAsyncComponent(() => import('./ProseH6-Cf6Ntzv2.mjs').then((r) => r["default"] || r.default || r));
const LazyProseHr = defineAsyncComponent(() => import('./ProseHr-C1EKwvNt.mjs').then((r) => r["default"] || r.default || r));
const LazyProseImg = defineAsyncComponent(() => import('./ProseImg-8pLIIR3k.mjs').then((r) => r["default"] || r.default || r));
const LazyProseLi = defineAsyncComponent(() => import('./ProseLi-Drw9JVP2.mjs').then((r) => r["default"] || r.default || r));
const LazyProseOl = defineAsyncComponent(() => import('./ProseOl-Bq-WgXMf.mjs').then((r) => r["default"] || r.default || r));
const LazyProseP = defineAsyncComponent(() => import('./ProseP-DQDh6OYC.mjs').then((r) => r["default"] || r.default || r));
const LazyProseStrong = defineAsyncComponent(() => import('./ProseStrong-U6OiYUcl.mjs').then((r) => r["default"] || r.default || r));
const LazyProseTable = defineAsyncComponent(() => import('./ProseTable-Bu0H5rp4.mjs').then((r) => r["default"] || r.default || r));
const LazyProseTbody = defineAsyncComponent(() => import('./ProseTbody-BjoWZWEM.mjs').then((r) => r["default"] || r.default || r));
const LazyProseTd = defineAsyncComponent(() => import('./ProseTd-DVWhLTY0.mjs').then((r) => r["default"] || r.default || r));
const LazyProseTh = defineAsyncComponent(() => import('./ProseTh-BKbDdiXn.mjs').then((r) => r["default"] || r.default || r));
const LazyProseThead = defineAsyncComponent(() => import('./ProseThead-UPf7zyPH.mjs').then((r) => r["default"] || r.default || r));
const LazyProseTr = defineAsyncComponent(() => import('./ProseTr-ByCBRcxb.mjs').then((r) => r["default"] || r.default || r));
const LazyProseUl = defineAsyncComponent(() => import('./ProseUl-Dn-pxd0I.mjs').then((r) => r["default"] || r.default || r));
const LazyAlert = defineAsyncComponent(() => import('./Alert-B7l_iDZO.mjs').then((r) => r["default"] || r.default || r));
const LazyBadge = defineAsyncComponent(() => import('./Badge-BdP7VuHR.mjs').then((r) => r["default"] || r.default || r));
const LazyButtonLink = defineAsyncComponent(() => import('./ButtonLink-CDbAMl95.mjs').then((r) => r["default"] || r.default || r));
const LazyCallout = defineAsyncComponent(() => import('./Callout-1ZtLF02o.mjs').then((r) => r["default"] || r.default || r));
const LazyCodeBlock = defineAsyncComponent(() => import('./CodeBlock-DjGdUWTM.mjs').then((r) => r["default"] || r.default || r));
const LazyCodeGroup = defineAsyncComponent(() => import('./CodeGroup-bqZ0Yk_j.mjs').then((r) => r["default"] || r.default || r));
const LazyContainer = defineAsyncComponent(() => Promise.resolve().then(() => Container).then((r) => r["default"] || r.default || r));
const LazyCopyButton = defineAsyncComponent(() => import('./CopyButton-iCT1MjHT.mjs').then((r) => r["default"] || r.default || r));
const LazyList = defineAsyncComponent(() => import('./List-BCmRqBMI.mjs').then((r) => r["default"] || r.default || r));
const LazyNuxtImg = defineAsyncComponent(() => import('./NuxtImg-xhY2BGpi.mjs').then((r) => r["default"] || r.default || r));
const LazyProps = defineAsyncComponent(() => import('./Props-DU4CRq5l.mjs').then((r) => r["default"] || r.default || r));
const LazySandbox = defineAsyncComponent(() => import('./Sandbox-CQPCyNxm.mjs').then((r) => r["default"] || r.default || r));
const LazyTabsHeader = defineAsyncComponent(() => import('./TabsHeader-7YItXRgd.mjs').then((r) => r["default"] || r.default || r));
const LazyTerminal = defineAsyncComponent(() => import('./Terminal-DXVMYa5h.mjs').then((r) => r["default"] || r.default || r));
const LazyVideoPlayer = defineAsyncComponent(() => import('./VideoPlayer-bqslSazV.mjs').then((r) => r["default"] || r.default || r));
const LazyIconCodeSandBox = defineAsyncComponent(() => import('./IconCodeSandBox-Bu9CM39U.mjs').then((r) => r["default"] || r.default || r));
const LazyIconDocus = defineAsyncComponent(() => import('./IconDocus-BQaOE-Bw.mjs').then((r) => r["default"] || r.default || r));
const LazyIconNuxt = defineAsyncComponent(() => import('./IconNuxt-Rr8VVJKt.mjs').then((r) => r["default"] || r.default || r));
const LazyIconNuxtContent = defineAsyncComponent(() => import('./IconNuxtContent-Bi2WkABX.mjs').then((r) => r["default"] || r.default || r));
const LazyIconNuxtLabs = defineAsyncComponent(() => import('./IconNuxtLabs-DvGtrN-Y.mjs').then((r) => r["default"] || r.default || r));
const LazyIconNuxtStudio = defineAsyncComponent(() => import('./IconNuxtStudio-FlLspIOz.mjs').then((r) => r["default"] || r.default || r));
const LazyIconStackBlitz = defineAsyncComponent(() => import('./IconStackBlitz-CK9Rx3Yh.mjs').then((r) => r["default"] || r.default || r));
const LazyIconVueTelescope = defineAsyncComponent(() => import('./IconVueTelescope-DT9Z9XUU.mjs').then((r) => r["default"] || r.default || r));
const LazyBlockHero = defineAsyncComponent(() => import('./BlockHero-B9Kebv3C.mjs').then((r) => r["default"] || r.default || r));
const LazyCard = defineAsyncComponent(() => import('./Card-yx_gsqMJ.mjs').then((r) => r["default"] || r.default || r));
const LazyCardGrid = defineAsyncComponent(() => import('./CardGrid-h3dzaDWD.mjs').then((r) => r["default"] || r.default || r));
const LazyVoltaBoard = defineAsyncComponent(() => import('./VoltaBoard-s0nZruOv.mjs').then((r) => r["default"] || r.default || r));
const LazyComponentPlayground = defineAsyncComponent(() => import('./ComponentPlayground-DOsfDm0j.mjs').then((r) => r["default"] || r.default || r));
const LazyComponentPlaygroundData = defineAsyncComponent(() => import('./ComponentPlaygroundData-DCdE3VUB.mjs').then((r) => r["default"] || r.default || r));
const LazyComponentPlaygroundProps = defineAsyncComponent(() => import('./ComponentPlaygroundProps-Czm__8h3.mjs').then((r) => r["default"] || r.default || r));
...
const LazyPreviewLayout = defineAsyncComponent(() => import('./PreviewLayout-DlRjQ5Sv.mjs').then((r) => r["default"] || r.default || r));
const LazyTokensPlayground = defineAsyncComponent(() => import('./TokensPlayground-pZtlIA6D.mjs').then((r) => r["default"] || r.default || r));
const LazyContentDoc = defineAsyncComponent(() => import('./ContentDoc-zcE9t982.mjs').then((r) => r["default"] || r.default || r));
const LazyContentList = defineAsyncComponent(() => import('./ContentList-a98TkqcD.mjs').then((r) => r["default"] || r.default || r));
const LazyContentNavigation = defineAsyncComponent(() => import('./ContentNavigation-DpQgdGQb.mjs').then((r) => r["default"] || r.default || r));
const LazyContentQuery = defineAsyncComponent(() => import('./ContentQuery-DzrbYvR3.mjs').then((r) => r["default"] || r.default || r));
const LazyContentRenderer = defineAsyncComponent(() => import('./ContentRenderer-hPTthXTG.mjs').then((r) => r["default"] || r.default || r));
const LazyContentRendererMarkdown = defineAsyncComponent(() => import('./ContentRendererMarkdown-BL4ERlDp.mjs').then((r) => r["default"] || r.default || r));
...
const LazyProsePre = defineAsyncComponent(() => import('./ProsePre-DkZBJuDb.mjs').then((r) => r["default"] || r.default || r));
...
const LazyIconCSS = defineAsyncComponent(() => import('./IconCSS-CHAqOTm-.mjs').then((r) => r["default"] || r.default || r));
...
const createQueryFetch = () => async (query) => {
  ...
  if (shouldUseClientDB()) {
    const db = await import('./client-db-CVsj3wqd.mjs').then((m) => m.useContentDatabase());
...
const fetchContentNavigation = async (queryBuilder) => {
  ...
  if (shouldUseClientDB()) {
    const generateNavigation = await import('./client-db-CVsj3wqd.mjs').then((m) => m.generateNavigation);
...
const layouts = {
  default: defineAsyncComponent(() => import('./default-B7ysDATN.mjs').then((m) => m.default || m)),
  page: defineAsyncComponent(() => import('./page-xdxaI1_E.mjs').then((m) => m.default || m))
};
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-yam7xiPk.mjs'));
    const _Error = defineAsyncComponent(() => import('./error-500-DdP0jn5X.mjs'));
...
export { useVModel as A, usePinceauTheme as B, queryContent as C, fetchContentNavigation as D, get$1 as E, assertArray as F, ensureArray as G, omit as H, sortList as I, apply as J, withoutKeys as K, LayoutMetaSymbol as L, withKeys as M, createQuery as N, PageRouteSymbol as P, _export_sfc as _, __nuxt_component_0$5 as a, useNuxtApp as b, useRoute as c, appLayoutTransition as d, entry_default as default, _wrapInTransition as e, useRuntimeConfig as f, useContent as g, useRequestEvent as h, useContentHead as i, usePinceauRuntime as j, useContentPreview as k, layouts as l, __nuxt_component_0$3 as m, computedStyle as n, useDocus as o, __nuxt_component_0$2 as p, useAppConfig as q, useState as r, __nuxt_component_0$4 as s, useContentHelpers as t, useHead as u, useRouter as v, useClipboard as w, onClickOutside as x, useAsyncData as y, useColorMode as z };
